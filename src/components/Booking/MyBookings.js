...
//       setBookings([]); // Clear existing bookings to prevent duplicates
//       const data = snapshot.val();
//       if (data !== null) {
//         const userBookings = Object.values(data).filter((booking) => booking.refID === user.email);
...
//     if (!bookingId) return; // Ensure bookingId exists
