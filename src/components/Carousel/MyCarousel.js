...
import slider2 from '../../imgs/hotel2.jpg';
import slider3 from '../../imgs/hotel3.jpg';
import slider4 from '../../imgs/hotel4.jpg';
import './MyCarousel.css';
import { Link } from 'react-router-dom';
...
const MyCarousel = (props) => {
    return (
        <div className="carousel slide" id="carouselExampleIndicators" data-ride="carousel" data-interval="3000">
            <ol className="carousel-indicators">
                <li data-target="#carouselExampleIndicators" data-slide-to="0" className="active"></li>
                <li data-target="#carouselExampleIndicators" data-slide-to="1"></li>
                <li data-target="#carouselExampleIndicators" data-slide-to="2"></li>
            ...
            <div className="carousel-inner" role="listbox">
                ...
                <div className="carousel-item" style={sliderStyle4}>
                    <div className="carousel-caption text-center">
                        <h1>{props.title}</h1>
                        <h3>{props.subtitle}</h3>
                        <Link to="/rooms"><a className="btn btn-outline-light btn-lg carousel-btn">Our Rooms</a></Link>
